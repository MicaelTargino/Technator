...
-- DELETE FROM linkedfacts;
-- DELETE FROM facts;
-- DELETE FROM characters;
-- DROP TABLE characters;
-- DROP TABLE facts;
-- DROP TABLE linkedfacts;
...
-- INSERT INTO facts (description, type) VALUES
-- ('was a woman', 'general'),
-- ('was a British mathematician', 'general'),
-- ('was an American computer scientist', 'general'),
-- ('was considered the first computer programmer', 'specific'),
-- ('developed the concept of the Turing Machine', 'specific'),
-- ('developed the first compiler for a computer programming language', 'specific'),
-- ('was a pioneer in computer science', 'general'),
-- ('was a co-founder of a major tech company', 'general'),
-- ('was influential in the development of the internet', 'general'),
-- ('invented a programming language', 'specific'),
-- ('created significant software', 'specific'),
-- ('designed influential computer hardware', 'specific');
...
-- -- Inserting data into `linkedfacts` table (ensure no duplicates)
-- INSERT INTO linkedfacts (character_id, fact_id) VALUES
-- (1, 1), -- Ada Lovelace was a woman
-- (1, 4), -- Ada Lovelace was considered the first computer programmer
-- (1, 7), -- Ada Lovelace was a pioneer in computer science
...
-- (7, 3), -- Ken Thompson was an American computer scientist
-- (9, 3), -- Steve Wozniak was an American computer scientist
-- (12, 3); -- Linus Torvalds, although Finnish, has made significant contributions to American computer science